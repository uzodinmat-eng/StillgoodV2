  ...
  return (
    <main className="min-h-screen grid place-items-center bg-slate-50 p-6">
      <div className="text-center space-y-3 max-w-md">
        <h1 className="text-xl font-black text-slate-900">Admin desk hit a snag</h1>
        <p className="text-sm text-slate-600">
          We could not load the admin desk. Confirm you are signed in with an admin account.
        </p>
